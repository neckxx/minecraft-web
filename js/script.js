...
const config = {
    serverInfo: {
        ...
        serverName: "TerraNesia", /*Server name*/
        serverIp: "play.terranesia.my.id", /*Server IP (if you want to add online user counter, you must have true the enable-status and enable-query of server.properties)*/
        discordServerID: "1213512367359533066" /*Your server ID (if you want to add online user counter, you must have enabled Discord server widget)*/
    },
    ...
    */
    contactPage: {
        email: "terranesiabusiness@gmail.com"
    }
}
